...
class RewardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post rewards_url, params: { reward: { donation_amount: @reward.donation_amount, gift: @reward.gift, project_id: @reward.project_id, user_id: @reward.user_id, user_limit: @reward.user_limit } }
    end
  ...
  test "should update reward" do
    patch reward_url(@reward), params: { reward: { donation_amount: @reward.donation_amount, gift: @reward.gift, project_id: @reward.project_id, user_id: @reward.user_id, user_limit: @reward.user_limit } }
