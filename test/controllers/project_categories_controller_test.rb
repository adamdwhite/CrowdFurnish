...
class ProjectCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_category" do
    assert_difference('ProjectCategory.count') do
      post project_categories_url, params: { project_category: { category_id: @project_category.category_id, project_id: @project_category.project_id } }
    end
  ...
  test "should update project_category" do
    patch project_category_url(@project_category), params: { project_category: { category_id: @project_category.category_id, project_id: @project_category.project_id } }
